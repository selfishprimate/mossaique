...
**That's it!** 🎉 You only need to edit README.md. The JSON files are automatically generated by GitHub Actions when your changes are merged to main.
...
1. Edit `README.md` directly on main or in a branch
...
1. **Trigger:** Runs when README.md is changed on main branch
...
- ✅ When a PR is merged to main (and README.md changed)
- ✅ When you push directly to main (and README.md changed)
...
6. **GitHub Actions** will automatically run after your PR is merged to main
...
**Step 2 - Commit and push to main (or merge PR)**
